...
export class DataService {
  ...
  private selectedPartner: BehaviorSubject<BusinessPartnerSearchResult>;

  constructor(public router: Router, public http: Http) {
    this.http = http;

    this.selectedPartner = new BehaviorSubject<BusinessPartnerSearchResult>({
      id: "",
      created_by: "",
      name: "",
      mobile_numbar: "",
  ...
  profile_get_me(userId) {
    ...
    return (this.profileMeObservable = this.authApi
      .usersMeProfileGet(userId)
      .share());
  }
  ...
  profile_put(userId: number, profile: models.PersonalDetails) {
    if (!this.profileObservable) {
      ...
      this.profileObservable = this.authApi.usersUserIdProfilePut(
        userId,
        profile
      );
    }
  ...
  public user_saved_searches_post(
    userId: number,
  ...
  public user_upload_resume_parsing(file: any): Observable<any> {
    ...
    let fileUploadObservable =
      this.authApi.usersUserUploadResumeParsingPost(file);
  ...
  public fetchUserResume(userId: string, filenType: string): Observable<any> {
    ...
    let fileUploadObservable = this.authApi.usersUserFetchResumeGet(
      userId,
      filenType
    );
    return fileUploadObservable;
  ...
  preferences_get(userId: number) {
    ...
    return this.authApi
      .usersUserIdPreferencesGet(userId)
      .share()
      .map(TransformerService.transformPreferences);
  }
  ...
  skills_put(userId: number, id: number, level: models.NewTechSkillLevel) {
    ...
    let dictionaryObservable = this.skillsApi.usersUserIdTechIdPut(
      userId,
      id,
      level
    );
  ...
  skills_delete(userId: number, id: number) {
    ...
    let dictionaryObservable = this.skillsApi.usersUserIdTechIdDelete(
      userId,
      id
    );
    return dictionaryObservable;
  ...
  skills_tech_post(userId: number, skill) {
    ...
    let dictionaryObservable = this.skillsApi.usersUserIdTechPost(
      userId,
      dictionaryRequest
    );
    return dictionaryObservable;
  ...
  dictionary_tech_get(entityName: string, searchPhrase: string) {
    ...
    let dictionaryObservable = this.dictionaryApi.dictionaryTechGet(
      dictionaryRequest.value
    );
    return dictionaryObservable;
  }
  ...
  dictionary_focusareas_post(name: string) {
    ...
    let dictionaryObservable =
      this.dictionaryApi.dictionaryFocusareasPost(name);
    return dictionaryObservable;
  }
  ...
  dictionary_studyfields_post(name: string) {
    ...
    let dictionaryObservable =
      this.dictionaryApi.dictionaryStudyfieldsPost(name);
    return dictionaryObservable;
  }
  ...
  languages_get(userId: number) {
    ...
    return this.languagesApi
      .usersUserIdLanguagesGet(userId)
      .share()
      .map(TransformerService.transformLanguages);
  }

  dictionary_languages_get(
    entityName: string,
    searchPhrase: string,
    extended?: boolean
  ) {
    ...
    let dictionaryObservable = this.dictionaryApi.dictionaryLanguagesGet(
      dictionaryRequest.value,
      extended
    );
    return dictionaryObservable;
  ...
  languages_post(userId: number, language: models.Language) {
    ...
    let dictionaryObservable = this.languagesApi.usersUserIdLanguagesPost(
      userId,
      language
    );
    return dictionaryObservable;
  ...
  public dictionary_schools_get(
    ...
    let dictionary$ = this.dictionaryApi.dictionarySchoolsGet(
      dictionaryRequest.value
    );
    return dictionary$;
  }

  dictionary_company_get(
    entityName: string,
    searchPhrase: string
  ): Observable<models.DictionaryItem[]> {
    let dictionaryRequest = <models.DictionaryRequest>{
    ...
    let dictionary$ = this.dictionaryApi.dictionaryCompanyGet(
      dictionaryRequest.value
    );
    return dictionary$;
  }
  ...
  dictionary_industry_get(entityName: string, searchPhrase: string) {
    ...
    let dictionaryObservable = this.dictionaryApi.dictionaryIndustryGet(
      dictionaryRequest.value
    );
    return dictionaryObservable;
  }
  ...
  dictionary_job_title_get(entityName: string, searchPhrase: string) {
    ...
    let dictionaryObservable = this.dictionaryApi.dictionaryJobtitleGet(
      dictionaryRequest.value
    );
    return dictionaryObservable;
  }
  ...
  dictionary_seniority_get(entityName: string, searchPhrase: string) {
    ...
    let dictionaryObservable = this.dictionaryApi.dictionarySeniorityGet(
      dictionaryRequest.value
    );
    return dictionaryObservable;
  }
  ...
  dictionary_locations_get(entityName: string, searchPhrase: string) {
    ...
    let dictionaryObservable = this.dictionaryApi.locationsGet(
      dictionaryRequest.value
    );
    return dictionaryObservable;
  }
  ...
  locations_get(
    ...
    return this.dictionaryApi
      .locationsGet(searchQuery, state, country, expand)
  ...
  user_traits_get(userId: number) {
    if (!this.traitsObservable) {
      ...
      this.traitsObservable = this.traitsApi
        .usersUserIdTraitsGet(userId)
        .share()
        .map(TransformerService.transformTraits);
    }
  ...
  user_statistics_get(userId: number, since: number) {
    ...
    let userStatsObservable = this.authApi.usersUserIdStatisticsGet(
      userId,
      since
    );
  ...
  blocked_companies_get(userId: number) {
    if (!this.blockedCompaniesObservable) {
      ...
      this.blockedCompaniesObservable = this.authApi
        .usersUserIdBlockedGet(userId)
        .share();
    }
  ...
  blocked_companies_put(userId: number, blockAll: number) {
    ...
    let blockAllObservable = this.authApi.usersUserIdBlockedPut(
      userId,
      blockAll
    );
    return blockAllObservable;
  ...
  blocked_companies_delete(userId: number, id: number) {
    ...
    let blockAllObservable = this.authApi.usersUserIdBlockedIdDelete(
      userId,
      id
    );
    return blockAllObservable;
  ...
  education_delete(userId: number, id: number) {
    ...
    let educationObservable = this.educationsApi.usersUserIdEducationIdDelete(
      userId,
      id
    );
  ...
  education_post(userId: number, education: models.Education) {
    ...
    let educationObservable = this.educationsApi.usersUserIdEducationPost(
      userId,
      education
    );
    return educationObservable;
  ...
  experience_post(userId: number, position: models.Position) {
    ...
    let experienceObservable = this.experiencesApi.usersUserIdExperiencePost(
      userId,
      position
    );
  ...
  public experience_delete(userId: number, id: number): Observable<Response> {
    ...
    let experience$ = this.experiencesApi.usersUserIdExperienceIdDelete(
      userId,
      id
    );
    return experience$;
  ...
  experience_put(
    ...
    let experience$ = this.experiencesApi.usersUserIdExperienceIdPut(
      userId,
      id,
      experience
    );
  ...
  education_put(userId: number, id: number, education: models.Education) {
    ...
    let educationObservable = this.educationsApi.usersUserIdEducationIdPut(
      userId,
      id,
      education
    );
  ...
  dictionary_studyfields_get(entityName: string, searchPhrase: string) {
    ...
    let dictionaryObservable = this.dictionaryApi.dictionaryStudyfieldsGet(
      dictionaryRequest.value
    );
    return dictionaryObservable;
  }
  ...
  dictionary_traits_get(entityName: string, searchPhrase: string) {
    ...
    let dictionaryObservable = this.dictionaryApi.dictionaryTraitsGet(
      dictionaryRequest.value
    );
    return dictionaryObservable;
  }

  dictionary_focusarea_get(
    entityName: string,
    searchPhrase: string,
    extended?: boolean
  ) {
    ...
    let dictionaryObservable = this.dictionaryApi.dictionaryFocusareasGet(
      dictionaryRequest.value,
      extended
    );
    return dictionaryObservable;
  ...
  dictionary_get(entityName: string, searchPhrase: string) {
    ...
    let dictionaryObservable = this.dictionaryApi.dictionaryPost([
      dictionaryRequest,
    ]);
    return dictionaryObservable;
  }
  ...
  business_get(businessId: number) {
    ...
    let businessGetObservable =
      this.businessApi.businessBusinessIdGet(businessId);
  ...
  business_put(businessId: number, business?: models.Business) {
    ...
    let businessObservable = this.businessApi.businessBusinessIdPutWithHttpInfo(
      businessId,
      business
    );
  ...
  credits_put(businessId: number, settings: models.CreditsSettings) {
    ...
    let creditsSettingsObservable =
      this.businessApi.businessBusinessIdCreditsPut(businessId, settings);
  ...
  public credits_post(
    ...
    let creditsPost$ = this.businessApi.businessBusinessIdCreditsPost(
      businessId,
      packageId,
      stripeToken,
      billingName
   ...
   */
  public getPaymentsByBusinessId(
    businessId: number
  ...
  public payments_put(
    ...
    let paymentsPut$ = this.businessApi.businessBusinessIdPaymentsIdPut(
      businessId,
      id,
      token
    );
  ...
  public purchase_history_get(
    ...
    let purchaseHistory$ = this.businessApi.businessBusinessIdPurchasesGet(
      businessId,
      months
    );
  ...
  recruiters_get(businessId: number) {
    ...
    let recruitersGetObservable =
      this.businessApi.businessBusinessIdRecruitersGet(businessId);
  ...
  public recruiters_put(
    ...
    let recruitersPutObservable =
      this.businessApi.businessBusinessIdRecruitersIdPut(
        businessId,
        id,
        purchasePermission
      );
  ...
  public recruiters_delete(
    ...
    let recruitersDelete$ =
      this.businessApi.businessBusinessIdRecruitersIdDelete(businessId, id);
  ...
  recruiters_post(businessId: number, recruiter?: models.NewRecruiter) {
    ...
    let recruitersPostObservable =
      this.businessApi.businessBusinessIdRecruitersPost(businessId, recruiter);
  ...
  business_statistics_get(businessId: number) {
    ...
    let businessStatisticsGetObservable =
      this.businessApi.businessBusinessIdStatisticsGet(businessId);
  ...
  business_searches_get(businessId: number, from?: Date, to?: Date) {
    ...
    let businessSearchesGetObservable =
      this.businessApi.businessBusinessIdSearchesGet(businessId, from, to);
  ...
  business_searches_put(
    ...
    let businessSearchesPutObservable =
      this.businessApi.businessBusinessIdSearchesIdPut(businessId, id, status);
  ...
  business_search_get_results(businessId: number, id: number) {
    ...
    let businessSearchResultsGetObservable =
      this.businessApi.businessBusinessIdResultsIdGet(businessId, id);
    return businessSearchResultsGetObservable;
  }

  purchase_applicants_post(
    fullname: string,
    company: string,
    message: string,
    ...
    return this.businessApi.businessBusinessIdPurchasesPost(
      fullname,
      company,
      message,
      recruitingfor,
  ...
  update_applicant_status(
    ...
    return this.businessApi.businessBusinessChnageApplicantstatus(
      status,
      businessId,
      applicants
    );
  ...
  send_contact_request(userId, fullname, company, email, phone, message) {
    ...
    return this.authApi.usersUserIdRequestsPost(
      userId,
      fullname,
      company,
      email,
  ...
  //  * Subscription
  //  */
  public subscription_post(
    userId: number,
    stripeToken: string = null,
    billingName?: string
  ): Observable<Response> {
    let subscriptionsPost$ = this.authApi.userSubscriptionPost(
      userId,
      stripeToken,
      billingName
    );
  ...
  public subscription_put(
    userId: number,
    stripeToken: string = null,
    billingName?: string
  ): Observable<Response> {
    let subscriptionsPut$ = this.authApi.userSubscriptionPut(
      userId,
      stripeToken,
      billingName
    );
  ...
  public getPartners(
    ...
    let subscriptionsGet$ = this.businessApi.getPartners(
      userId,
      offset,
      orderby,
      order,
  ...
  public savePartner(
    ...
    let subscriptionsPut$ = this.businessApi.businessPartnerPostWithHttpInfo(
      userId,
      businessPartner
    );
    return subscriptionsPut$;
  ...
  public updatePartner(
    ...
    let subscriptionsPut$ = this.businessApi.businessPartnerPutWithHttpInfo(
      partnerId,
      businessPartner
    );
    return subscriptionsPut$;
  ...
  setSelectedPartnerDetail(partnerDetail: BusinessPartnerSearchResult) {
    this.selectedPartner.next(partnerDetail);
  }
