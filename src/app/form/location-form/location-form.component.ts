...
export class LocationFormComponent implements OnInit {
  @ViewChild("autoCompleteLocation") autocompleteElement: AutoComplete;

  @Output() onSelected = new EventEmitter<LocationExt>();
  @Output() onBlur = new EventEmitter<LocationExt>();
  ...
  searchLocation(event) {
    ...
    this.locations$ = this.dataService
      .locations_get(event.query, null, null, true)
      .subscribe(
  ...
  onFocusOut(location: LocationExt) {
    this.location = location;
    this.onBlur.emit(location);
  }
